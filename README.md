Laptop (fork of thoughtbot's laptop project for Linux)
======

Laptop is a script to set up a Linux laptop for web and mobile development.
...
```sh
curl --remote-name https://raw.githubusercontent.com/ealvar3z/setup/main/thinkpad
```
